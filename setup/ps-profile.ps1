...
if ($PSVersionTable.PSEdition -eq "Core") {
    Update-Profile -filePath "$docsPath\PowerShell\Microsoft.PowerShell_profile.ps1"
} elseif ($PSVersionTable.PSEdition -eq "Desktop") {
    Update-Profile -filePath "$docsPath\WindowsPowerShell\Microsoft.PowerShell_profile.ps1"
} else {
